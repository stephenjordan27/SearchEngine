...
public class Preprocessor {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    //stop words
                    processedLine = removeStopWords(processedLine);
                    
                    //stemming
                    processedLine= stem(processedLine);
    ...
    /**
     * Melakukan lemmatization pada sebuah baris pada dokumen,dengan menggunakan
     * stanfordCoreNLP API (https://stanfordnlp.github.io/CoreNLP/)
     *
